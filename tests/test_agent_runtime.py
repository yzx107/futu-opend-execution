...
class AgentRuntimeTests(unittest.TestCase):
    def test_cli_parser_accepts_core_commands(self) -> None:
        ...
        evaluate_new = parser.parse_args(["evaluate-newly-listed", "--listing-year", "2026", "--validation-days", "2", "--universe-path", "/tmp/u.parquet"])
        ...
        self.assertEqual(evaluate_new.command, "evaluate-newly-listed")
